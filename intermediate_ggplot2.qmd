...
A common issue can be that for plots that contain many elements, such as a
scatter plot for thousands of genes, the resulting plot file may get large
