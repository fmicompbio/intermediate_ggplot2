...
pos_levels <- expand.grid(letters[seq_len(7)], seq_len(5)) %>%
    tidyr::unite(col = "final_position", c("Var2", "Var1"), sep = "") %>%
...
* The combined plot could also have been generated with `cowplot` - however, 
that is a lot more resource intensive. 
